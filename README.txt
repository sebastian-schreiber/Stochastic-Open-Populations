...
clams.Rdata The data generated by Example-Clam-IPM.R One can load this data prior to the figure creation code in Example-Clam-IPM.R to create the figures without rerunning the simulations. 
